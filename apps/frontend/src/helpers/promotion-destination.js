...
//   2. Otherwise the fest the sponsor is attached to, inside the app.
//   3. Otherwise nowhere — the card is a billboard, not a control.
//
// The creative's media is never a destination: a tap does not open the video.
//
...
// case should open that redirect URL (which records the click and forwards)
